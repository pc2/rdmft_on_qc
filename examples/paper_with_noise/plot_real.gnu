...
set arrow 1 from 109,0 to 109,0.5 nohead dt "-"
set arrow 2 from 180,0 to 180,0.5 nohead dt "-"
set arrow 3 from 272,0 to 272,0.5 nohead dt "-"
set arrow 4 from 375,0 to 375,0.5 nohead dt "-"
set arrow 5 from 445,0 to 445,0.5 nohead dt "-"
set arrow 6 from 520,0 to 520,0.5 nohead dt "-"

F=0.18436311216650209
plot [:617][0:0.5] "rdmft_min" u ($0):($6) with l ls 3 t "$\\langle \\hat W_1 \\rangle$/t", \
"rdmft_min" u ($0):($8) with l ls 4 t "$\\sum_i c_i^2$", \
...
!ps2eps -f plot.ps
!ps2pdf plot.ps
!mv plot.pdf conv_noise_real.pdf
