...
set arrow 1 from 133,0 to 133,0.5 nohead dt "-"
set arrow 2 from 206,0 to 206,0.5 nohead dt "-"
set arrow 3 from 285,0 to 285,0.5 nohead dt "-"
set arrow 4 from 362,0 to 362,0.5 nohead dt "-"

F=0.18436311216650209
plot [:362][:] "< grep rdmf_obj_eval sim.out" u ($2):($6) with l ls 3 t "$\\langle \\hat W_1 \\rangle$/t", \
