...
set arrow 1 from 129,0 to 129,0.5 nohead dt "-"
set arrow 2 from 204,0 to 204,0.5 nohead dt "-"
set arrow 3 from 285,0 to 285,0.5 nohead dt "-"
set arrow 4 from 362,0 to 362,0.5 nohead dt "-"
set arrow 5 from 439,0 to 439,0.5 nohead dt "-"

F=0.18436311216650209
plot [:513][0:0.5] "< grep rdmf_obj_eval sim.out" u ($2):($6) with l ls 3 t "$\\langle \\hat W_1 \\rangle$/t", \
"< grep rdmf_obj_eval sim.out" u ($2):($8) with l ls 4 t "$\\sum_i c_i^2$", \
